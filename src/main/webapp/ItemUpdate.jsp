...
<div class="content">
	...
	<h3 style="margin-left: 40px;">Update Item</h3>
		<div class="formBody">
			...
			<div class="mb-3 row g-3">
			  ...
			  <textarea  name="itemDescription" style="min-height:50px;" class="form-control form-control-sm inpt"  required><%=resultSet.getString("itemDescription") %></textarea>
			  <div class="invalid-feedback">
			...
			<div class="mb-3 row g-3">
			  ...
			  <input type="number" name="itemPrice" class="form-control form-control-sm inpt" value="<%=resultSet.getString("itemPrice") %>" required>
			  <div class="invalid-feedback">
