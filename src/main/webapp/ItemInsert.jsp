...
<div class="sidebar">
  ...
  <a class="active" href="ItemInsert.jsp"><i class='far fa-plus-square' style='font-size:20px;color:blue'></i> Add Items</a>
...
<div class="content">
	...
	<h3 style="margin-left: 40px;">Add Items</h3>
		<div class="formBody">
			...
			<div class="mb-3 row g-3">
				<div class="col-md-4">
					<label class="form-label lbl">Price</label> 
					<input type="number" name="itemPrice" class="form-control form-control-sm inpt" placeholder="0000.00"
						required>
					<div class="invalid-feedback">Please enter the price.</div>
				</div>
				
				<div class="col-md-8">
					<label class="form-label lbl">Upload Image</label> 
					<input style="height:auto;" type="file" name="itemImage" class="form-control form-control-sm inpt" required>
				</div>
			</div>
