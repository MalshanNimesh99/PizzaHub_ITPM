...
.inptid{  width: 230px; border-style: none; font-weight: bold; font-size: large; }
...
<div class="innerBody">
	...
	<div class="bdform">
		<h4 class="col-md-8 title2" >Update Your Card Details...</h4>
  		<br>
...
<%
	...
	%>
		...
		<form method="post" action="UpdatePaymentServlet" class=" needs-validation"  novalidate>
		
		<div class="mb-3" style="display: none;"  >
			  <label class="form-label lbl">Payment ID</label>
			  <input type="text" name="paymentID" class="form-control form-control-sm inptid" value="<%=paymentID%>" readonly>
		</div>
			
			<div class="mb-3">
			  <label class="form-label lbl">Card Holder name</label>
			  <input type="text" name="cHName" style="text-transform: capitalize;" class="form-control form-control-sm inptname" placeholder="Name..." value="<%=cName%>" required>
			...
			<div class="mb-3">
			  ...
			  <input type="text" id="cnum" name="cardNumber" class="form-control form-control-sm inptcnum" placeholder="XXXX XXXX XXXX XXXX" value="<%=cardNumber%>" required>
			  <img src="Images/atm cards.png" style="width: 30px; height: 30px; margin-left: 5px;"></div>
			  <div class="invalid-feedback">
			...
			<div class="col-md-6">
			  ...
			  <select name="expDatem" class="form-control form-control-sm inptex"  required>
						<option selected value="<%=expDatem %>"><%=expDatem %></option>
			  ...
			  <select name="expDatey" class="form-control form-control-sm inptex"  required>
						<option selected value="<%=expDatey %>"><%=expDatey %></option>
			...
			<div class="mb-3">
			  ...
			  <input type="number" name="cvv" class="form-control form-control-sm inptcvv" placeholder="cvv" value="<%=cvv %>" required>
			  <div class="invalid-feedback">
				      Please enter the cvv.
				</div>
			</div>
			<div class="mb-3">
			  <button class="btn btn-primary" style="width: 300px;" type="submit">Update</button>
			</div>
        </form>
       </div>
   </div>
