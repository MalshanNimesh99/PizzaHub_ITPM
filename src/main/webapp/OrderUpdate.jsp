...
<h2 class="txt3" style="margin-left: 150px;">Update Order</h2>
  		<br>
...
<td><h4 class="txt5"><input type="text" name="idorder" value="<%= idorder%>" class="form-input" readonly></h4></td>
</tr>
<tr>
<td><h4 class="txt4">Name</h4> </td>
<td> <h4 class="txt5"><input type="text" name="name" value="<%= name%>"class="form-input"></h4></td>
</tr>
<tr>
<td><h4 class="txt4">Address </h4></td>
<td><h4 class="txt5"><input type="text" name="address" value="<%= address%>"class="form-input"></h4></td>
</tr>
<tr>
<td><h4 class="txt4">Telephone </h4></td>
<td><h4 class="txt5"><input type="text" name="telephone" value="<%= telephone%>"class="form-input"></h4></td>
</tr>
<tr>
<td><h4 class="txt4">Flavour</h4></td>
<td><h4 class="txt5"> <select name="flavour" class="form-input" style= "width:260px;"  >
			  	<option selected value="<%= flavour%>"><%= flavour%></option>
...
<td><h4 class="txt5"><select name="type" class="form-input"style= "width:260px;"  >
...
<td> <h4 class="txt5"><select name="size" class="form-input" style="width:260px;" >
...
<td> <h4 class="txt5"><select name="cheese" class="form-input" style="width:260px;">
...
<td> <h4 class="txt5"><input type="text" name="instructions" value="<%= instructions%>"class="form-input"></h4></td></tr>
...
<div class="mb-3">
			  <button class="btn btn-dark" style="width: 310px;margin-right:80px;" type="submit">Update</button> 
