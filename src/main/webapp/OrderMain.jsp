...
<button style="width:200px;height:50px;" class="btn btn-dark"onclick="document.location='OrderInsert.jsp'">Add Order</button>


<br>
<br>

<button style="width:200px;height:50px;" class="btn btn-dark" onclick="document.location='OrderSearch.jsp'">View Order</button>
