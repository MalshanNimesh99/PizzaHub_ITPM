...
<div class="sidebar">
 <div style="box-shadow: 0 4px 2px -2px gray; height: 50px;padding-top: 10px; background-color:#f2f2f0;"><img class="adminlogo" src="Images/adminAvatar.png">  Administrator</div>
  ...
  <a class="active" href="ItemReportGenerate.jsp"><i class='fas fa-download' style='font-size:20px;color:black'></i> Generate Report</a>
  </div>
...
<div class="content">
	...
	<h3 style="margin-left: 40px;">Item Report</h3><button class="btnd"  onclick="print()">Download Report <i class="fa fa-download"></i></button>
		<div class="formBody" id="list">
		<h4 style="text-align: center;height: 50px;padding-top: 20px;border-bottom: groove ">Pizza Hub Menu Item Report</h4>
