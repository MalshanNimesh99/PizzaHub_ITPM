...
<div class="innerBody">
	...
	<div class="bdform">
<h3 class="txt3">Place Your Valuable Order with Us</h3>
  		<br>

<form method="post" action="InsertOrderServlet" class=" needs-validation"  novalidate>



			<div class="mb-3">
			 <label class="form-label lbl">Name</label>
			  <input type="text"  name="name" class="form-control inpt" style="text-transform: capitalize;" placeholder="Enter Customer name"required>
			</div>
			
			<div class="mb-3">
			 <label class="form-label lbl">Address</label>
			  <textarea name="address" class="form-control inpt" style="text-transform: capitalize;" placeholder="Enter Address"required></textarea>
			</div>
			
			<div class="mb-3">
			 <label class="form-label lbl">Telephone Number</label>
			  <input type="number" name="telephone" class="form-control inpt"  placeholder="Enter Telephone Number"required>
			</div>
		
			<div class="mb-3">
			  <label class="form-label lbl">Select Flavour</label>
			  <select name="flavour" class="form-control inpt" required >
			  	<option selected value="">Select the falvour</option>
			...
			<div class="mb-3">
			  <label class="form-label lbl">Type</label>
			  <select name="type" class="form-control inpt" required >
			  	<option selected value="">Select the Type</option>
			...
			<div class="mb-3">
			   <label class="form-label lbl">Size</label>
			  <select name="size" class="form-control inpt" required >
			...
			<div class="mb-3">
			 <label class="form-label lbl">Need Extra Cheese</label>
			  <select name="cheese" class="form-control inpt">
			...
			<div class="mb-3">
			 <label class="form-label lbl">Special Instructions</label>
			  <textarea name="instructions" class="form-control inpt"  placeholder="Enter special Instructions"></textarea>
			</div>
			
			
			<div class="mb-3">
			  <button class="btn btn-dark" style="width: 310px;margin-right:80px;" type="submit">Add</button> 
			 
			  <button class="btn btn-warning" style="width: 310px;" type="reset">Clear</button>
			</div>
