...
<div class="content">
	...
	<h3 style="margin-left: 40px;">Filtered Items</h3>
		<div class="formBody">
		<table class="table table-striped tblS" >
				...
				if(itemCategory != null){
					sql ="select * from items where itemCategory='"+itemCategory+"'";
				}else{
				...
				<td style="max-width: 50px;">Rs.<%=resultSet.getString("itemPrice") %></td>
				<td style="max-width: 200px;"><img class="addedImg" src="Images/<%=resultSet.getString("itemImage") %>"></td>
				<td style="max-width: 80px;"><a class="updt" href="ItemUpdate.jsp?itemID=<%=resultSet.getString("itemID")%>">Update <i class="fa fa-edit" style="font-size:16px"></i></a></td>
				<td style="max-width: 80px;"><a class="dlt" href="ItemDelete.jsp?itemID=<%=resultSet.getString("itemID")%>">Delete <i class="fa fa-trash" style="font-size:16px"></i></a></td>
				</tr>
				<%
				}
				connection.close();
