...
.content {
  margin-left: 200px;
  height: 600px;
  background-image: url("photos/Pizza-Website-Background-3.jpg"); 
...
.cl{ background-color: white ; padding: 15px 5px 15px 5px; border-radius: 10px; border:1px solid black;
...
<body>
<div class="sidebar">
  <div style="box-shadow: 0 4px 2px -2px gray; height: 50px;padding-top: 10px; background-color:#f2f2f0;"><img class="adminlogo" src="photos/adminAvatar.png">  Administrator</div>
  <div class="sidebarG1">
  ...
  <a href="ItemReportGenerate.jsp"><i class='fas fa-download' style='font-size:20px;color:black'></i> Generate Report</a>
 	<div class="dropdown">
	  	<a class="dropbtn"><i class='fas fa-shipping-fast' style='font-size:20px;color:black'></i> Deliveries</a>
	 	 <div class="dropdown-content">
	    	<a href="DeliveryReport.jsp">Delivery Report</a>
	    	<a href="DeliverySerachProvince.jsp">Search Province</a>
	  		</div>
		</div>
   </div>
	...
	<div class="Bodycont">
		<div class="container">
	  		<div class="row">
	    			...
	    			<div style="margin-left: 20px;" class="col-5 cl">
	    				<label>Deliveries</label>
	    				<canvas id="myChartline" style="width:100%;max-width:600px"></canvas>
	    			</div>
	    		<div class="col-6 cl" style="margin-left: 40px;">
...
<!-- The ModalModalModalModalModalModal -->
